...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        Workout.objects.create(name='Morning Cardio', description='Run and cycle', duration=60)
        Workout.objects.create(name='Strength', description='Weights and pushups', duration=45)
